    ...
    public partial class Adduser : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "guesmiimahmoud@gmail.com", true, "$2a$11$NIP/piS6PvzbKU98O5OLBOEuP9yrF8DC2QiF5Z5FyxNLmR4J29pdy", null, null, "Client" },
                    { 2, "jane.smith@example.com", true, "$2a$11$6LEbkGEkjF84eAGJYvXgwO0jgIxb.9chueTxnLLqcp0JAqKd8CVEC", null, null, "Client" },
                    { 3, "agent@stb.com", true, "$2a$11$6TvBHkaaNqzqfNKbm8cDo.lrjm78uE7ZC1Giee5g4cX47GKdk/YgK", null, null, "Agent" }
                });

            migrationBuilder.InsertData(
                table: "Agents",
                columns: new[] { "Id", "Departement", "Nom", "Prenom", "UserId" },
                values: new object[] { 1, "Administration", "Admin", "STB", 3 });

            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "Adresse", "Civilite", "DateDelivranceCIN", "DateExpirationCIN", "DateNaissance", "Email", "EtatCivil", "Genre", "LieuDelivranceCIN", "Nationalite", "NiveauEducation", "Nom", "NomMere", "NomPere", "NombreEnfants", "NumCIN", "PaysNaissance", "PhotoClient", "Prenom", "Profession", "Residence", "RevenuMensuel", "SituationProfessionnelle", "Telephone", "UserId" },
                values: new object[,]
                {
                    { 1, "123 Main St", "M", new DateTime(2010, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2030, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "guesmiimahmoud@gmail.com", "Célibataire", "Masculin", "New York", "US", "Master", "Doe", "Jane Doe", "John Doe Sr.", 2, "14668061", "USA", "mahmoud.jpg", "John", "Ingénieur", "New York", 5000.00m, "Employé", "123456789", 1 },
                    { 2, "456 Elm St", "Mme", new DateTime(2015, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2035, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "jane.smith@example.com", "Marié(e)", "Féminin", "Toronto", "CA", "Doctorat", "Smith", "Mary Smith", "Robert Smith", 1, "14668062", "Canada", "mahmoud.jpg", "Jane", "Médecin", "Toronto", 7000.00m, "Indépendant", "987654321", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "14668061", false, 1, new DateTime(2025, 3, 25, 20, 24, 54, 651, DateTimeKind.Local).AddTicks(2077), "john.doe@example.com", false, false, "VisaClassic", "12345678923537902652", "12345678", "DisponibleEnAgence", "International" },
                    { 2, "14668062", false, 2, new DateTime(2025, 3, 25, 20, 24, 54, 651, DateTimeKind.Local).AddTicks(2200), "jane.smith@example.com", false, false, "Mastercard", "65432110223463790345", "87654321", "EnPreparation", "National" }
                });
