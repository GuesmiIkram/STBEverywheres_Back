...
namespace STBEverywhere_Back_SharedModels.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
<<<<<<<< HEAD:STBEverywhere_Back_SharedModels/Migrations/20250415133303_initial.cs
            ...
            migrationBuilder.CreateTable(
========
>>>>>>>> 4638078 (reclamation/chequier):STBEverywhere_Back_SharedModels/Migrations/20250414130534_globalmigration.cs
                name: "PackElyssa",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:STBEverywhere_Back_SharedModels/Migrations/20250415133303_initial.cs
                    { 1, "guesmiimahmoud@gmail.com", true, "$2a$11$4w6q.9zysWG8gvZaP414we/cYEdKMhCQkVAtLKvqB.k7R3ivnFuoS", null, null, "Client" },
                    { 2, "jane.smith@example.com", true, "$2a$11$wYQTdpE.IfIJVPK2fQh7CupbZQL4c5HRpHuMeoMQHVV1CmBJhDfN.", null, null, "Client" },
                    { 3, "agent@stb.com", true, "$2a$11$w4yfwHmwXZmcJO7EU2Wxo.x/R58jF2VB0BW.dp1Z032rVMfmAdW5G", null, null, "Agent" },
                    { 4, "robert.smith@example.com", true, "$2a$11$ZdgxNND75Cc7wWPUUHU6bOU6E1ibwGI3b/hxGY/aOBuTkMQ4sbk3.", null, null, "Client" },
                    { 5, "agent5@stb.com", true, "$2a$11$8GRVNRs7NrU6P0yn2kyw2.T/0TSHLxeJzfAjQLqwhezJ8QMA01016", null, null, "Agent" }
========
                    { 1, "guesmiimahmoud@gmail.com", true, "$2a$11$UsgGmUcvr/reX2vczXFtHeNFkDbhgr6o3D1KA8EQP00UA/xN6XVeW", null, null, "Client" },
                    { 2, "jane.smith@example.com", true, "$2a$11$.S6W9ANg3dgQ81TkO/GWVOCBnIa135ts5vY/aCAKXd0vp8G9ijCgu", null, null, "Client" },
                    { 3, "agent@stb.com", true, "$2a$11$OJ2bjGVzZnRfw33YkI/pDu25fw0FguE3Zu9IpfpNysOtLwQ2IqYu.", null, null, "Agent" },
                    { 4, "robert.smith@example.com", true, "$2a$11$if9tkSXdV5FY2HpsK7/5LuQ.86G2h7Z42i5prPUEGy36z75XFM7hG", null, null, "Client" },
                    { 5, "agent5@stb.com", true, "$2a$11$XqsY2p2VxpXlmvWqIeeNpu0MmLnrUol3Oxsvis2JLE3iv9gPxYEhq", null, null, "Agent" }
>>>>>>>> 4638078 (reclamation/chequier):STBEverywhere_Back_SharedModels/Migrations/20250414130534_globalmigration.cs
                });
            ...
            migrationBuilder.InsertData(
                table: "Comptes",
                columns: new[] { "RIB", "ClientId", "DateCreation", "DecouvertAutorise", "IBAN", "MontantMaxAutoriseParJour", "NbrOperationsAutoriseesParJour", "NumCin", "Solde", "Statut", "Type", "idAgent" },
                values: new object[,]
                {
                    { "12345678923537902652", 1, new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "TN2110500678923537952", 0m, null, "14668061", 1000.50m, "Actif", "Courant", null },
                    { "65432110223463790345", 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "TN1210500110223463745", 0m, null, "14668062", 5000.00m, "Actif", "Epargne", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:STBEverywhere_Back_SharedModels/Migrations/20250415133303_initial.cs
                    { 1, "14668061", false, new DateTime(2025, 4, 15, 14, 33, 2, 993, DateTimeKind.Local).AddTicks(6884), "john.doe@example.com", false, false, "VisaClassic", "12345678923537902652", "12345678", "DisponibleEnAgence", "International" },
                    { 2, "14668062", false, new DateTime(2025, 4, 15, 14, 33, 2, 993, DateTimeKind.Local).AddTicks(6952), "jane.smith@example.com", false, false, "Mastercard", "65432110223463790345", "87654321", "EnPreparation", "National" }
========
                    { 1, "14668061", false, new DateTime(2025, 4, 14, 14, 5, 33, 320, DateTimeKind.Local).AddTicks(2570), "john.doe@example.com", false, false, "VisaClassic", "12345678923537902652", "12345678", "DisponibleEnAgence", "International" },
                    { 2, "14668062", false, new DateTime(2025, 4, 14, 14, 5, 33, 320, DateTimeKind.Local).AddTicks(2592), "jane.smith@example.com", false, false, "Mastercard", "65432110223463790345", "87654321", "EnPreparation", "National" }
>>>>>>>> 4638078 (reclamation/chequier):STBEverywhere_Back_SharedModels/Migrations/20250414130534_globalmigration.cs
                });
